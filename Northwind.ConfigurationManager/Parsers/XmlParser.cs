...
namespace Northwind.ConfigurationManager.Parsers
{
    public class XmlParser : ISerrializer, IDeserializer
    {
        ...
        List<DeserializableObject> Parse(string xml, bool trim)
        {
        ...
        string GetNextTag(string xml, int startIndex)
        {
        ...
        object GetEnumerableInstance(DeserializableObject obj, Type type)
        {
            Type genericArgument = type.GenericTypeArguments.Length == 0 ? type.GetElementType() : type.GenericTypeArguments[0];
